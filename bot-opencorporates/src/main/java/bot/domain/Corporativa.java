...
public class Corporativa extends ValueObject {
  ...
  private final LocalDate yearStarted;
  private final LocalDate dateStarded;
  ...
  public LocalDate getDateStarded() {
    return dateStarded;
  }
